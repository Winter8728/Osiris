...
<script type="text/javascript">    
    ...
    $(function() {       
        ...
        function InitTable(pageIndex) {                                
            $.ajax({ 
                type: "POST",
                dataType: "text",
                url: '/DeviceManager/AllDeviceList',      //提交到一般处理程序请求数据
   ...
   <table id="Result" cellspacing="0" cellpadding="0" class="public-cont-table" >          
			<tr>
				<th style="width:10%">终端编号</th>
				<th style="width:5%">亮度</th>				
                <th style="width:5%">温度</th>	
                <th style="width:5%">功耗</th>	
                <th style="width:8%">显示模式</th>	
                <th style="width:5%">陀螺仪</th>	
                <th style="width:5%">开关</th>	
                <th style="width:7%">经度</th>
                <th style="width:7%">纬度</th>	
                <th style="width:8%">是否锁定</th>	
